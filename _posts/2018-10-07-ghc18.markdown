...
- technical skills through workshop or ideas and talks. However whether this applies to you or not, depends on many factors, since - given the breadth of audience background and topics - the level of the workshops is usually entry-level, while there can be talks on advanced topics and advanced research results.
